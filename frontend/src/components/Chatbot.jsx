...
const Chatbot = ({ retailerId, retailerName, isCustomer = false }) => {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            // Auto-speak if enabled and successful
            if (autoSpeak && !isCustomer && response.data.success) {
                    ...
                    {!isCustomer && (
                        <>
                            <button
                                ...
                                className={`p-1 rounded transition-colors ${autoSpeak ? 'bg-white/20' : 'hover:bg-white/20'
                                    }`}
            ...
            <div className="p-4 border-t border-gray-200 bg-white rounded-b-lg">
                <div className="flex items-center space-x-2">
                    <input
                        ...
                        placeholder={`Type your message... (${currentLang.icon} ${currentLang.name})`}
